...
import { Github, Linkedin, Mail, Heart, Home, Briefcase, Rocket, MessageSquare } from 'lucide-react'
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              >
                <Link to={ROUTES.HOME} className="flex items-center mb-4 group">
                  <div className="w-10 h-10 rounded-full border-2 border-cyan-400 p-0.5 relative group overflow-hidden mr-3">
                    <img
                      src={profileImage}
                      alt="Profile"
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center gap-3 w-full">
                      ...
                      <div>
                        <span className="text-gray-300 group-hover:text-cyan-200 transition-colors font-medium block">
                          vimukthibudi0007@
                          icloud.com
                        </span>
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-300 text-sm">
                © {currentYear} Developed by Vimukthi Buddika 
              </p>
              <p className="text-gray-300 text-sm mt-2 md:mt-0 flex items-center">
                Made with VibeCode and modern web technologies
              </p>
            </div>
          </motion.div>
        </div>
